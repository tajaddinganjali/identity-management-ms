...
public class TimeBasedOTP extends HmacOTP {
    ...
    public String generateTOTP(String secretKey) {
        long interval = this.clock.getCurrentInterval();

        String steps = Long.toHexString(interval).toUpperCase();
    ...
    private class Clock {
        ...
        public long getCurrentInterval() {
            ...
            if (currentCalendar == null) {
                currentCalendar = Calendar.getInstance(TimeZone.getTimeZone("UTC"));
            }
