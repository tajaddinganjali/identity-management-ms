...
@Table(name = "REGISTER_LIMIT_CONFIG")
public class RegisterLimitConfig extends AbstractEntity {

    @Id
    @GeneratedValue(generator = "register_limit_config_seq_generator")
    @SequenceGenerator(name = "register_limit_config_seq_generator",
            sequenceName = "register_limit_config_seq", allocationSize = 1)
    private long id;
