...
@Table(name = "REGISTER_LIMIT")
public class RegisterLimit extends AbstractEntity {

    @Id
    @GeneratedValue(generator = "register_limit_seq_generator")
    @SequenceGenerator(name = "register_limit_seq_generator", sequenceName = "register_limit_seq", allocationSize = 1)
    private long id;
    ...
    private RegisterLimitConfig registerLimitConfig;
